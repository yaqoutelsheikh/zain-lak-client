...
import type { MediaTone, ProductType } from "../types";

export const productIcons: Record<ProductType, LucideIcon> = {
    physical: Package,
    digital: Download,
    service: Sparkles,
    tour: Ticket,
...
export const toneClassNames: Record<MediaTone, string> = {
